...
void deterministic_devoxelize_wrapper(int N, int c, int l, const int * indices, const float * weight, const float * feat, float * out);
void deterministic_devoxelize_grad_wrapper(int N, int n, int c, int l, const int * indices, const float * weight, const float * top_grad, int * bottom_grad);
