...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("sparsedwconv_forward", &DepthwiseConvolutionForwardGPU, "point cloud convolution forward (CUDA)");
    m.def("sparsedwconv_backward", &DepthwiseConvolutionBackwardGPU, "point cloud convolution backward (CUDA)");
    ...
    m.def("deform_kernel_hash_forward", &deform_kernel_hash_forward, "Deform Kernel Hashing forward (CUDA)"); // haw
